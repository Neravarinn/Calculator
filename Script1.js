...
button.addEventListener("mouseover", () => {
    button.childNodes.forEach((el, index) => {
        ...
        if (button.children[index] !== undefined) {
           // button.children[index].onmouseover = () => button.children[index].style.color = "red"
            if (button.children[index].innerText == "=") {
                ...
                if(DegCheck.checked) button.children[index].onclick = () =>{
                    mainInput = inputB.children[0].value
                    inputB.children[0].value = Math.cos(engine(inputB.children[0].value)*Math.PI/180)
                    if (inputB.children[0].value=="NaN")
                        inputB.children[0].value = "Wrong input!"
                    addLI(('cos('+mainInput+')'), inputB.children[0].value)
                }
                else button.children[index].onclick = () =>{
                    mainInput = inputB.children[0].value
                    inputB.children[0].value = Math.cos(engine(inputB.children[0].value))
                    if (inputB.children[0].value=="NaN")
                        inputB.children[0].value = "Wrong input!"
                    addLI(('cos('+mainInput+')'), inputB.children[0].value)
                }           
                ...
                if(DegCheck.checked) button.children[index].onclick = () =>{
                    mainInput = inputB.children[0].value
                    inputB.children[0].value = Math.acos(engine(inputB.children[0].value))/Math.PI*180
                    if (inputB.children[0].value=="NaN")
                        inputB.children[0].value = "Wrong input!"
                    addLI(('arccos('+mainInput+')'), inputB.children[0].value)
                }
                else button.children[index].onclick = () =>{
                    mainInput = inputB.children[0].value
                    inputB.children[0].value = Math.acos(engine(inputB.children[0].value))
                    if (inputB.children[0].value=="NaN")
                        inputB.children[0].value = "Wrong input!"
                    addLI(('arccos('+mainInput+')'), inputB.children[0].value)
                }  
                ...
                if(DegCheck.checked) button.children[index].onclick = () =>{
                    mainInput = inputB.children[0].value
                    inputB.children[0].value = Math.sin(engine(inputB.children[0].value)*Math.PI/180)
                    if (inputB.children[0].value=="NaN")
                        inputB.children[0].value = "Wrong input!"
                    addLI(('sin('+mainInput+')'), inputB.children[0].value)
                }
                else button.children[index].onclick = () =>{
                    mainInput = inputB.children[0].value
                    inputB.children[0].value = Math.sin(engine(inputB.children[0].value))
                    if (inputB.children[0].value=="NaN")
                        inputB.children[0].value = "Wrong input!"
                    addLI(('sin('+mainInput+')'), inputB.children[0].value)
                }                
                ...
                if(DegCheck.checked) button.children[index].onclick = () =>{
                    mainInput = inputB.children[0].value
                    inputB.children[0].value = Math.asin(engine(inputB.children[0].value))/Math.PI*180
                    if (inputB.children[0].value=="NaN")
                        inputB.children[0].value = "Wrong input!"
                    addLI(('arcsin('+mainInput+')'), inputB.children[0].value)
                }
                else button.children[index].onclick = () =>{
                    mainInput = inputB.children[0].value
                    inputB.children[0].value = Math.asin(engine(inputB.children[0].value))
                    if (inputB.children[0].value=="NaN")
                        inputB.children[0].value = "Wrong input!"
                    addLI(('arcsin('+mainInput+')'), inputB.children[0].value)
                }
                ...
                if(DegCheck.checked) button.children[index].onclick = () =>{
                    mainInput = inputB.children[0].value
                    inputB.children[0].value = Math.tan(engine(inputB.children[0].value)*Math.PI/180)
                    if (inputB.children[0].value=="NaN")
                        inputB.children[0].value = "Wrong input!"
                    addLI(('tan('+mainInput+')'), inputB.children[0].value)
                }
                else button.children[index].onclick = () =>{
                    mainInput = inputB.children[0].value
                    inputB.children[0].value = Math.tan(engine(inputB.children[0].value))
                    if (inputB.children[0].value=="NaN")
                        inputB.children[0].value = "Wrong input!"
                    addLI(('tan('+mainInput+')'), inputB.children[0].value)
                }
                ...
                if(DegCheck.checked) button.children[index].onclick = () =>{
                    mainInput = inputB.children[0].value
                    inputB.children[0].value = Math.atan(engine(inputB.children[0].value))/Math.PI*180
                    if (inputB.children[0].value=="NaN")
                        inputB.children[0].value = "Wrong input!"
                    addLI(('arctan('+mainInput+')'), inputB.children[0].value)
                }
                else button.children[index].onclick = () =>{
                    mainInput = inputB.children[0].value
                    inputB.children[0].value = Math.atan(engine(inputB.children[0].value))
                    if (inputB.children[0].value=="NaN")
                        inputB.children[0].value = "Wrong input!"
                    addLI(('arctan('+mainInput+')'), inputB.children[0].value)
                }
                ...
                button.children[index].onclick = () =>inputB.children[0].value =inputB.children[0].value + Math.PI
            }
            else if (button.children[index].innerText == "sqrt"){
                button.children[index].onclick = () =>{
                    mainInput = inputB.children[0].value
                    inputB.children[0].value =Math.sqrt(engine(inputB.children[0].value))
                    if (inputB.children[0].value=="NaN")
                        inputB.children[0].value = "Wrong input!"
                ...
                button.children[index].onclick = () => hisBlock.children[0].innerHTML = ""
            }
            else if(button.children[index].innerText == 'C'){
                button.children[index].onclick = () => inputB.children[0].value = ''
            }
            else {
                button.children[index].onclick = () => inputB.children[0].value += button.children[index].innerText
            }
            
            if (button.children[index].style.color === "red") {
                button.children[index].onmouseout = () => button.children[index].style.color = "black"
            }
...
function engine(inputString) {
    var stringMod = inputString.split("").filter(elem => (elem !== " ") && (elem !== ",") && (elem !== "_")).map(elem => (elem == "–") ? elem = "-" : elem).join("")
    ...
    for (var i = 0; i<= (stringMod.length-1); i++){
        ...
        if (Number.isInteger(+ stringMod[i]) == true && minusIndecator == true){
        ...
        } else if (stringMod[i] == '.' && Number.isInteger(+ stringMod[i+1]) == true && minusIndecator == true){
            for (var j = i+1; j <= (stringMod.length - 1); j++){
                i = j;
                if (Number.isInteger(+ stringMod[j]) === false && stringMod[j] !== '.')
                {
        ...
        } else if(stringMod[i] == '.' && Number.isInteger(+ stringMod[i+1]) == true){
            for (var j = i+1; j <= (stringMod.length - 1); j++){
                i = j;
                if (Number.isInteger(+ stringMod[j]) === false && stringMod[j] !== '.')
                {
            ...
            if (tokens.length==0)
                token = '-1'
            else if (Number.isInteger(+ stringMod[i-1]) == true)
                token = '-1'
            else if (Number.isInteger(+ stringMod[i+1]) !== true)
                token = '-1'
        ...
        if(tokens.length == 0){
            ...
            if(token==')'){
                ...
                do{
                    if (tokens[tokens.length-1].startsWith('+')==true){
                    ...
                    }else if(tokens[tokens.length-1].startsWith('-')==true){
                        if(k===0){
                            number = -numbers[k]
                            numbers.splice(k,1)
                            numbers.push(number)
                        ...
                        tokens.splice((tokens.length-1),1)
                        if(tokens.length == 0) break d1
                    }else if(tokens[tokens.length-1].startsWith('sqrt')==true){
                        ...
                        tokens.splice((tokens.length-1),1)
                        if(tokens.length == 0) break d1
                    }else if(tokens[tokens.length-1].startsWith('sin')==true){
                        if (DegCheck.checked)
                        number = Math.sin(numbers[k] * Math.PI/180)
                        else
                        number = Math.sin(numbers[k])
                        numbers.splice(k,1)
                        numbers.push(number)
                        tokens.splice((tokens.length-1),1)
                        if(tokens.length == 0) break d1
                    }else if(tokens[tokens.length-1].startsWith('cos')==true){
                        if (DegCheck.checked)
                        number = Math.cos(numbers[k] * Math.PI/180)
                        else
                        number = Math.cos(numbers[k])
                        numbers.splice(k,1)
                        numbers.push(number)
                        tokens.splice((tokens.length-1),1)
                        if(tokens.length == 0) break d1
                    }else if(tokens[tokens.length-1].startsWith('tan')==true){
                        if (DegCheck.checked)
                        number = Math.tan(numbers[k] * Math.PI/180)
                        else
                        number = Math.tan(numbers[k])
                        numbers.splice(k,1)
                        numbers.push(number)
                        tokens.splice((tokens.length-1),1)
                        if(tokens.length == 0) break d1
                    }else if(tokens[tokens.length-1].startsWith('e')==true){
                        number = numbers[k-1]*Math.pow(10,numbers[k])
                        numbers.splice((k-1),2)
                        numbers.push(number)
                        tokens.splice((tokens.length-1),1)
                        if(tokens.length == 0) break d1
                    }else if(tokens[tokens.length-1].startsWith('arctan')==true){
                        if (DegCheck.checked)
                        number = Math.atan(numbers[k])/Math.PI*180
                        else
                        number = Math.atan(numbers[k])
                        numbers.splice(k,1)
                        numbers.push(number)
                        tokens.splice((tokens.length-1),1)
                        if(tokens.length == 0) break d1
                    }else if(tokens[tokens.length-1].startsWith('arccos')==true){
                        if (DegCheck.checked)
                        number = Math.acos(numbers[k])/Math.PI*180
                        else
                        number = Math.acos(numbers[k])
                        numbers.splice(k,1)
                        numbers.push(number)
                        tokens.splice((tokens.length-1),1)
                        if(tokens.length == 0) break d1
                    }else if(tokens[tokens.length-1].startsWith('arcsin')==true){
                        if (DegCheck.checked)
                        number = Math.asin(numbers[k])/Math.PI*180
                        else
                        number = Math.asin(numbers[k])
                        numbers.splice(k,1)
                        numbers.push(number)
                        tokens.splice((tokens.length-1),1)
                        if(tokens.length == 0) break d1
                ...
                tokens.push(token)
                continue next
            }else if(parseInt(token[token.length-1])>parseInt(tokens[tokens.length-1][tokens[tokens.length-1].length-1])){
                tokens.push(token)
                continue next
            }else if(parseInt(token[token.length-1])<=parseInt(tokens[tokens.length-1][tokens[tokens.length-1].length-1])){
                d4:
                ...
                }while(parseInt(token[token.length-1])<=parseInt(tokens[tokens.length-1][tokens[tokens.length-1].length-1]) && tokens[tokens.length-1] !=='(')        
                tokens.push(token)       
            }      
        }
    ...
    inputB.children[0].value = "Wrong input!";
        ...
        inputB.children[0].value = numbers[numbers.length-1];
